...
type Snapshot struct {
	...
	PostgresRole             PostgresRole `json:"postgres_role"`                  // postgres
	...
	PostgresCurrentLSN       string       `json:"postgres_current_lsn,omitempty"` // postgres
	PostgresReplayLSN        string       `json:"postgres_replay_lsn,omitempty"`  // postgres
}
